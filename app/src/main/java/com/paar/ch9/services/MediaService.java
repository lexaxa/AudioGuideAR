...
//            Log.d(TAG, "initPlayer: opened audio file " + afd.toString() );
...
//                            Log.d(TAG, "run: " + isPlaying + "=" + isPlayingA.get());
    ...
    public void handleActionPlay(String fileName) {
        ...
        Log.d(TAG, "handleActionPlay: " + fileName + "->" + ((mMediaPlayer!=null)?mMediaPlayer.isPlaying():""));
        Log.d(TAG, (trackName == null) + "||" + (mMediaPlayer == null) + "||" + trackName + "=" + fileName);

        if(trackName == null || mMediaPlayer == null || !TextUtils.equals(trackName, fileName)){
            Log.d(TAG, "handleActionPlay: stop play '" + trackName + "'.");
            handleActionStop();
            setTrack(fileName);
            initPlayer();
        }else{
    ...
    private void handleActionStop() {
        ...
        isPlaying = false;
        Log.d(TAG, "handleActionStop: stopped");
    }
