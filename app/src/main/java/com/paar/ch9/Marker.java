...
import com.paar.ch9.camera.CameraModel;
import com.paar.ch9.paintable.PaintableBox;
import com.paar.ch9.paintable.PaintableBoxedText;
import com.paar.ch9.paintable.PaintableGps;
import com.paar.ch9.paintable.PaintableObject;
import com.paar.ch9.paintable.PaintablePosition;
...
public class Marker implements Comparable<Marker> {
    ...
    protected volatile boolean isInDesc = false;
	...
	public Marker(String name, double latitude, double longitude, double altitude, int color, String audioFileName) {
...
/*
    ...
    protected synchronized void drawIcon(Canvas canvas) {
        ...
        if (gpsSymbol==null) gpsSymbol = new PaintableGps(18, 1, true, getColor());
    ...
    protected synchronized void drawText(Canvas canvas) {
	    ...
	    float maxHeight = Math.round(canvas.getHeight() / 20f) + 1;
	    ...
	    float y = textArray[1] + maxHeight - 30;
